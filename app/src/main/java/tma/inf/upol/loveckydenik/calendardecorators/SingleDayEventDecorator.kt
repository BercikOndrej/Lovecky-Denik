...
import tma.inf.upol.loveckydenik.spans.SingleDayLineSpan
import java.time.LocalDate

class SingleDayEventDecorator(val ctx: Context, var eventItems: MutableList<CalendarEvent>)
    : DayViewDecorator {
    val color: Int
    ...
    override fun decorate(view: DayViewFacade) {
        view.addSpan(SingleDayLineSpan(color))
    }
